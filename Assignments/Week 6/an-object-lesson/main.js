...
myObject.firstName = 'Chynna';

// Add a `lastName` property and set it to a string.
myObject.lastName = 'Wetzel';
...
myObject.address.push('1234 Walnut St');
myObject.address.push('Apt 563');
myObject.address.push('Muscatine, IA');
...
const newObject = {
  ...
  numberProperty: 42,
  arrayProperty: ['apple', 'banana', 'cherry'],
